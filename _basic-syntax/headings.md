...
syntax-summary: |
  ...
  ## H2
  ### H3
description: "要创建标题， 请在词组或短语前添加井号 (`#`) 。 您使用的井号的数量应与标题级别相对应。例如，要创建三级标题 (`<h3>`)，请使用三个井号（例如， `### 我的标题`)。"
examples:
  - markdown: "# 一级标题"
    html: "<h1>一级标题</h1>"
  - markdown: "## 二级标题"
...
additional-examples:
  - name: "替代语法"
    description: "或者，在文本下方的行中，为一级标题添加任意数量的 == 。"
    markdown: |
      一级标题
      ===============
    html: "<h1>一级标题</h1>"
  - name: "二级标题的替代语法"
    description: "或者，在文本下方的行中，为二级标题添加任意数量的 -- 。"
    markdown: |
      二级标题
      ---------------
    html: "<h2>二级标题</h2>"
...
要创建标题， 请在词组或短语前添加井号 (`#`) 。 您使用的井号的数量应与标题级别相对应。例如，要创建三级标题 (`<h3>`)，请使用三个井号（例如， `### 我的标题`)。
